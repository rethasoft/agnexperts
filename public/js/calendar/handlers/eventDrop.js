export function handleEventDrop(info) {
    ...
    // The drag is already complete at this point, so we can show the confirmation dialog
    // without affecting the drag performance
    Swal.fire({
        title: 'Wilt u de datum van dit evenement wijzigen?',
        icon: 'question',
        ...
        if (result.isConfirmed) {
            ...
            .then(data => {
                ...
                if (!data.success) {
                    ...
                    Swal.fire({
                        title: 'Fout!',
                        text: data.message || 'Datum kon niet worden bijgewerkt.',
                        icon: 'error',
                        timer: 2000,
                    ...
                    Swal.fire({
                        title: 'Gelukt!',
                        text: 'Datum is succesvol bijgewerkt.',
                        icon: 'success',
                        timer: 1500,
                        showConfirmButton: false
                    });
