...
<head>
    ...
    <title>Service Selection Steps</title>
            ...
            <div id="step1" class="step-content active">
                ...
                <div class="mb-5">
                    ...
                    <div class="row g-4">
                        <div class="col-md-4">
                            <div class="service-card">
                                <input type="radio" name="service" id="service1" value="service1">
                                <label class="form-check-label w-100" for="service1">
                        ...
                        <div class="col-md-4">
                            <div class="service-card">
                                <input type="radio" name="service" id="service2" value="service2">
                                <label class="form-check-label w-100" for="service2">
                                    <i class="fas fa-hard-hat"></i>
                                    <span>Asbestos Check</span>
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="service-card">
                                <input type="radio" name="service" id="service3" value="service3">
                                <label class="form-check-label w-100" for="service3">
                ...
                <div class="mb-5">
                    ...
                    <div class="row g-4">
                        <div class="col-md-4">
                            <div class="service-card">
                                <input type="checkbox" id="subService1">
                                <label class="form-check-label w-100" for="subService1">
                                    <i class="fas fa-house-user"></i>
                                    <span>Residential EPC</span>
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="service-card">
                                <input type="checkbox" id="subService2">
                                <label class="form-check-label w-100" for="subService2">
                                    <i class="fas fa-building"></i>
                        ...
                        <div class="col-md-4">
                            <div class="service-card">
                                <input type="checkbox" id="subService3">
                                <label class="form-check-label w-100" for="subService3">
