...
@section('keywords', 'over ons, AGN Experts, technische keuringen, expertise, België')
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    ...
                    <h1 class="simple-header-title mb-0">Over Ons</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 mb-30">
                        <div class="it-work-item text-center">
                            ...
                            <div class=it-work-content>
                                <h3 class=it-section-title-sm>EPC Attest</h3>
            ...
            <div class="row align-items-end">
                <div class="col-xl-6 col-lg-6">
                    <div class=it-testimonial-2-title-box>
                        ...
                        <p>Ontdek waarom klanten ons vertrouwen voor hun EPC Attest, elektrische keuring en asbestattest. Professionele service en expertise die het verschil maken.</p>
                    </div>
                    <div class=row>
                            ...
                            <div class=swiper-wrapper>
                                <div class=swiper-slide>
                                    <div class="it-testimonial-2-item p-relative">
                                        ...
                                        <p>"Zeer professionele service voor ons EPC Attest. De keuring werd grondig uitgevoerd en we kregen duidelijke uitleg over de resultaten. Een aanrader voor iedereen die een energieprestatiecertificaat nodig heeft."</p>
