            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="button-bar mb-2">
                        <a href="{{ route('client.create') }}" class="btn btn-success"><i class="ri-add-line"></i></a>
                    </div>
                            ...
                            @if ($data->count() > 0)
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('client.show', ['client' => $item->id]) }}"
                                                class="btn btn-sm btn-info d-inline-block">
                                                <i class="ri-eye-line"></i>
                                            </a>
                                            <form action="{{ route('client.edit', ['client' => $item->id]) }}"
