...
@section('content')
    ...
    <form action="{{ route('service.update', ['service' => $service->id]) }}" method="POST" enctype="multipart/form-data" onsubmit="return false;">
        @csrf
        @method('PUT')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="data[name]" class="form-control" autocomplete="off"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="short_description" name="data[short_description]" class="form-control"
                                autocomplete="off" value="{{ $service->short_description }}">
                        </div>

                        <div class="mb-4">
                            <label for="description" class="form-label">Beschrijving</label>
                            <div id="editor">{!! $service->description !!}</div>
                                <input type="hidden" name="data[description]" id="description">
                        </div>
                        ...
                        <div class="mb-4">
                            <img src="{{ asset($service->image) }}" alt="{{ $service->name }}" height="50"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="regions[]" value="brussel" id="region_brussel"
                                    {{ in_array('brussel', $service->regions ?? []) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="regions[]" value="vlaanderen" id="region_vlaanderen"
                                    {{ in_array('vlaanderen', $service->regions ?? []) ? 'checked' : '' }}>
