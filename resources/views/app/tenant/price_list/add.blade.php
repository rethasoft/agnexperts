            ...
            <div class="card-body">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('price-list.index') }}">{{ ucwords(Request::segment(2)) }}</a></li>
        ...
        <div class="col-lg-4 mb-3 mb-md-0">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <label for="client" class="form-label">Klanten</label>
                            <select name="data[client_id]" id="client" class="form-control" required>
