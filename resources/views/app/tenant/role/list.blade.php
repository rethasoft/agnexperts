                ...
                <div class="card-body">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Rollen') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="button-bar mb-2">
                        <a href="{{ route('role.create') }}" class="btn btn-success"><i class="ri-add-line"></i></a>
                    </div>
                        ...
                        <tbody>
                            @if ($data->count() > 0)
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('role.edit', ['role' => $item->id]) }}" class="d-inline-block" method="GET">
                                            @csrf
                                            <button type="submit" class="btn btn-sm btn-success"><i class="ri-pencil-line"></i></button>
                                        </form>
                                        <form action="{{ route('role.destroy', ['role' => $item->id]) }}" class="d-inline-block" method="POST"
