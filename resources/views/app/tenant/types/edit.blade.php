...
<form action="{{ route('dienst.update', ['dienst' => $dienst->id]) }}" method="POST">
    @csrf
    @method('PUT')
        ...
        <div class="col-lg-4 mb-3 mb-md-0">
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <select name="data[category_id]" id="" class="form-control">
                                ...
                                @if ($types)
                                    @foreach ($types as $type)
                                        <option value="{{ $type->id }}" {{ $type->id == $dienst->category_id ? 'selected' : '' }}>{{ $type->short_name }}</option>
                                    @endforeach
                                @endif
                            </select>
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            ...
                            <input type="text" id="name" name="data[name]" class="form-control"
                                autocomplete="off" required value="{{ $dienst->name }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            ...
                            <input type="text" id="short_name" name="data[short_name]" class="form-control"
                                autocomplete="off" required value="{{ $dienst->short_name }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            ...
                            <input type="text" id="price" name="data[price]" class="form-control"
                                autocomplete="off" required value="{{ $dienst->price }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-lg-12">
                    ...
                    <div id="extra-price" class="row mb-3 {{ $dienst->extra == 0 ? 'd-none' : '' }}">
                        <div class="col-lg-12">
                            <label for="extra_price" class="form-label">Extra Prijs</label>
                            <input type="text" id="extra_price" name="data[extra_price]" class="form-control"
