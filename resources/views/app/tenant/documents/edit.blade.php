...
@section('content')
                ...
                <div class="card-body">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Map bewerken</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="row mt-3">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Map bewerken</h4>
                    ...
                    <form action="{{ route('documents.update', $folder->id) }}" method="POST"
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">Map bijwerken</button>
                        </div>
                    </form>
                </div>
            </div>
